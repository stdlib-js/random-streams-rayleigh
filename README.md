...
```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-rayleigh@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-streams-rayleigh/tags). For example,

```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-rayleigh@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var randomStream = require( 'path/to/vendor/umd/random-streams-rayleigh/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-rayleigh@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-streams-rayleigh.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-streams-rayleigh

[test-image]: https://github.com/stdlib-js/random-streams-rayleigh/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/random-streams-rayleigh/actions/workflows/test.yml?query=branch:v0.2.0
...
[cli-section]: https://github.com/stdlib-js/random-streams-rayleigh#cli
[cli-url]: https://github.com/stdlib-js/random-streams-rayleigh/tree/cli
[@stdlib/random-streams-rayleigh]: https://github.com/stdlib-js/random-streams-rayleigh/tree/main

[umd]: https://github.com/umdjs/umd
[es-module]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules

[deno-url]: https://github.com/stdlib-js/random-streams-rayleigh/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-streams-rayleigh/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-streams-rayleigh/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-streams-rayleigh/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-streams-rayleigh/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-streams-rayleigh/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-streams-rayleigh/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-streams-rayleigh/main/LICENSE
